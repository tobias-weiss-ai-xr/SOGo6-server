...
ERROR_SHARED_MAILBOX_MEMBER_NOT_FOUND = E("S000384", "Shared Mailbox Member Not Found", HTTPStatus.NOT_FOUND)
ERROR_SHARED_MAILBOX_MEMBER_ALREADY_EXISTS = E("S000385", "Shared Mailbox Member Already Exists", HTTPStatus.CONFLICT)
ERROR_SHARED_MAILBOX_ACCESS_DENIED = E("S000386", "Shared Mailbox Access Denied", HTTPStatus.FORBIDDEN)
ERROR_SHARED_MAILBOX_ROLE_INVALID = E("S000387", "Shared Mailbox Role Is Invalid", HTTPStatus.BAD_REQUEST)
ERROR_SHARED_MAILBOX_NOTE_NOT_FOUND = E("S000388", "Shared Mailbox Note Not Found", HTTPStatus.NOT_FOUND)
ERROR_SHARED_MAILBOX_ASSIGNMENT_NOT_FOUND = E("S000389", "Shared Mailbox Assignment Not Found", HTTPStatus.NOT_FOUND)
ERROR_SHARED_MAILBOX_ASSIGNMENT_ALREADY_EXISTS = E("S000390", "Shared Mailbox Assignment Already Exists", HTTPStatus.CONFLICT)
ERROR_SHARED_MAILBOX_ASSIGNMENT_ACCESS_DENIED = E("S000391", "Shared Mailbox Assignment Access Denied", HTTPStatus.FORBIDDEN)
ERROR_SHARED_MAILBOX_QUOTA_EXCEEDED = E("S000392", "Shared Mailbox Quota Exceeded", HTTPStatus.UNPROCESSABLE_ENTITY)
ERROR_SHARED_MAILBOX_NOT_ACTIVE = E("S000393", "Shared Mailbox Is Not Active", HTTPStatus.CONFLICT)
